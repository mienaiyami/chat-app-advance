					...
					>
						<div className="relative h-8 w-8 overflow-hidden rounded-full">
							{session?.user?.image ? (
								...
								<div className="flex h-full w-full items-center justify-center bg-blue-100 font-bold text-blue-600 text-sm dark:bg-blue-900 dark:text-blue-200">
				...
				<div className="mx-auto max-w-6xl">
					<div className="mb-6 flex items-center justify-between">
						...
						<div className="flex gap-2">
							<button
								onClick={() => router.push("/conversation/new/direct")}
							...
							<button
								onClick={() => router.push("/conversation/new/group")}
							...
							filteredConversations.map((conversation) => (
								...
								>
									<div className="flex items-center justify-between">
										<div className="flex items-center gap-3">
											<div className="relative h-12 w-12 overflow-hidden rounded-full">
												{conversation.image ? (
													...
													<div className="flex h-full w-full items-center justify-center bg-blue-100 font-bold text-blue-600 text-lg dark:bg-blue-900 dark:text-blue-200">
														{(conversation.name || "C").charAt(0)}
													</div>
												)}
											</div>
											<div>
										...
										<div className="text-right text-gray-500 text-sm dark:text-gray-400">
