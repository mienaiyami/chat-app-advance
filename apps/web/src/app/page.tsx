				...
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-8">
					<div className="flex flex-col gap-4 rounded-xl bg-white/10 p-6 text-white hover:bg-white/20">
						...
						<div className="text-lg">
							Connect directly with your contacts for private messaging.
						</div>
					</div>
					<div className="flex flex-col gap-4 rounded-xl bg-white/10 p-6 text-white hover:bg-white/20">
						<h3 className="font-bold text-2xl">Group Conversations</h3>
						<div className="text-lg">
							Create and participate in group discussions with multiple users.
						</div>
					</div>
				</div>
				...
				<div className="flex gap-4">
					{status === "unauthenticated" && (
						<>
							...
							<Link
								href="/auth/signup"
								className="rounded-full bg-white px-10 py-3 font-semibold text-blue-500 no-underline transition hover:bg-gray-100"
							>
								Sign Up
							</Link>
						</>
