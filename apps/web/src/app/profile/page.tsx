                ...
                <div className="w-full max-w-2xl rounded-lg bg-white p-8 shadow-lg dark:bg-gray-800">
                    ...
                    <div className="mb-8 rounded-md border border-gray-200 p-4 dark:border-gray-700">
                        ...
                        {userData?.settings ? (
                            ...
                            <p className="text-gray-500 dark:text-gray-400">
                                No settings found. Default settings will be
                                applied.
                            </p>
                        )}
                    </div>
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="flex w-full items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600"
                        >
