        ...
        <DialogContent className="cursor-default sm:max-w-[425px]">
            ...
            <div className="grid gap-2 py-4">
                ...
                <p
                    ...
                    title={formatDateLong(conversationDetails.createdAt)}
                >
                    <CalendarDays className="mr-1 h-4 w-4" />
                    Created on:{" "}
                    {formatDistanceToNow(
                        new Date(conversationDetails.createdAt),
                        {
                            addSuffix: true,
                        }
                    )}
                        ...
                        {isLoadingJoinLink ? (
                            ...
                            <div className="space-y-2">
                                ...
                                <p
                                    ...
                                    title={formatDateLong(joinLink.expiresAt)}
                                >
                                    Expires:{" "}
                                    {formatDate(
                                        new Date(joinLink.expiresAt),
                                        "dd/MM/yyyy HH:mm"
                                    )}
                                </p>
                                {isAdmin && (
