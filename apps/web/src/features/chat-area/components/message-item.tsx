...
export default function MessageItem({
    ...
    const formattedTimestamp = formatDateDistance(message.createdAt);
    ...
    return (
        <div
            className={cn(
                "group/message relative flex flex-col items-start rounded-sm hover:bg-accent/10",
        ...
        >
            ...
            <div className="flex w-full flex-row items-start gap-1.5">
                ...
                <div className="relative w-full">
                    <div
                        className={cn(
                            "w-fit max-w-80 break-words rounded-sm bg-accent/50 p-2 text-accent-foreground lg:max-w-2/3",
                    ...
                    {isEdited && !isSending && !isError && (
                        <div className="ml-1 select-none text-muted-foreground text-xs">
                            (edited)
                        </div>
                    )}
                    ...
                    >
                        ...
                        {canEdit && onEdit && !isSending && !isError && (
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Button
                                        variant="ghost"
